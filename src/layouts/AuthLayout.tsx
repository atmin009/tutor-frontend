          ...
          <div className="hidden items-center gap-4 md:flex">
            {!isLoggedIn ? (
              <>
                <Link
                  to="/auth/login"
                  className="rounded-full px-4 py-2 text-sm font-medium text-slate-600 hover:text-brand"
                >
                  เข้าสู่ระบบ
                </Link>
                <Link
            ...
            <nav className="flex flex-col px-4 py-4">
              ...
              {!isLoggedIn ? (
                <div className="mt-4 flex flex-col gap-2 border-t border-slate-200 pt-4">
                  <Link
                    to="/auth/login"
                    className="rounded-lg px-4 py-2 text-center text-sm font-medium text-slate-600 hover:bg-slate-50"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    เข้าสู่ระบบ
                  </Link>
                  <Link
                    to="/auth/register"
                    className="rounded-lg bg-brand px-4 py-2 text-center text-sm font-medium text-white hover:bg-brand/90"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    สมัครสมาชิก
                  </Link>
