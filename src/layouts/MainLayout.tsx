      ...
      <footer className="border-t bg-slate-50">
        <div className="mx-auto w-full max-w-6xl px-4 py-6">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Contact Info */}
            <div>
              <h3 className="text-base font-bold text-slate-900">ติดต่อเรา</h3>
              <div className="mt-2 space-y-1.5 text-xs text-slate-600">
                ...
                <div className="flex items-center gap-1.5">
                  <svg className="h-3.5 w-3.5 flex-shrink-0 text-slate-400" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Office Locations */}
            <div>
              <h3 className="text-base font-bold text-slate-900">ที่อยู่</h3>
              <div className="mt-2 space-y-2 text-xs text-slate-600">
                ...
                <div>
                  ...
                  <p className="mt-0.5 leading-snug">
                    เลขที่ 107/225 ซอยสุวินทวงศ์ 38 แขวงลำผักชี เขตหนองจอก กรุงเทพมหานคร 10530
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-base font-bold text-slate-900">ลิงก์ด่วน</h3>
          ...
          <div className="mt-4 border-t border-slate-200 pt-4">
            <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
              <div className="text-center sm:text-left">
                <p className="mb-2 text-xs font-medium text-slate-600">ช่องทางการชำระเงินที่รองรับ</p>
                <img
                  src="/PayLogo.png"
              ...
              <p className="text-xs text-slate-500">
                © {new Date().getFullYear()} Media & Training Co., Ltd.
              </p>
            </div>
          </div>
        </div>
